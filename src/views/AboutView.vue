    ...
    <div class="container">
      <div class="row8">
        <div class="col">
          <figure>
            <aside>
              GET BETTER DEALS <span>10%</span> OFF<span
                ><img
      ...
      <div class="row">
        ...
        <div class="col text-center" id="fill">
          <p>
            Our Goal is For Different Cars to be Adverted and Bought by Any And
            Everyone that visits our Site to want to Atleast Buy or sell a car.
          </p>
          <p>
            Our Goal is For Different Cars to be Adverted and Bought by Any And
            Everyone that visits our Site to want to Atleast Buy or sell a car.
      ...
      <div class="row" id="row">
        <h2 class="col ps-4" id="team">Our Team</h2>
        <div class="col">
          <img
