<template>
  <section id="products">
    <div v-if="user" class="container p-5">
    ...
    <div v-else>
      <div class="container bg-black">
        ...
        >
          <div class="text-white display-1 fw-bolder text-center">
    ...
    sortManu() {
      ...
      if (sort === "desc") {
        cars.sort(function (a, b) {
          var nameA = a.manufacturer.toLowerCase(),
            nameB = b.manufacturer.toLowerCase();
          if (nameA < nameB)
